...
const NAV = [
  ...
  { label: "Configure", href: CONFIGURE_URL },
            ...
            <div className="mt-10 border-t border-white/10 pt-6">
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div className="flex items-start justify-between rounded-lg border border-white/10 bg-black/50 px-5 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
                  <div>
                    <p className="text-[10px] font-semibold tracking-[0.32em] text-white/55">COVERAGE</p>
                    <p className="mt-2 text-xs font-medium text-white/70">Continuous intake and routing</p>
                  </div>
                  <p className="text-lg font-extrabold text-white/80">24/7</p>
                </div>

                <div className="flex items-start justify-between rounded-lg border border-white/10 bg-black/50 px-5 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
                  <div>
                    <p className="text-[10px] font-semibold tracking-[0.32em] text-white/55">RESPONSE SPEED</p>
                    <p className="mt-2 text-xs font-medium text-white/70">First-touch handling</p>
                  </div>
                  <p className="text-lg font-extrabold text-white/80">&lt;60s</p>
                </div>

                <div className="flex items-start justify-between rounded-lg border border-white/10 bg-black/50 px-5 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
                  <div>
                    <p className="text-[10px] font-semibold tracking-[0.32em] text-white/55">CONVERSION LIFT</p>
                    <p className="mt-2 text-xs font-medium text-white/70">Booked outcomes</p>
                  </div>
                  <p className="text-lg font-extrabold text-white/80">+42%</p>
                </div>

                <div className="flex items-start justify-between rounded-lg border border-white/10 bg-black/50 px-5 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
                  <div>
                    <p className="text-[10px] font-semibold tracking-[0.32em] text-white/55">OPERATIONAL EFFICIENCY</p>
                    <p className="mt-2 text-xs font-medium text-white/70">Manual workload</p>
                  </div>
                  <p className="text-lg font-extrabold text-white/80">-60%</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="space-y-12">
      <section className="rounded-[3rem] border-2 border-stone-900/10 bg-white/80 backdrop-blur-xl p-12 md:p-16 shadow-2xl text-left">
        <SectionHead
          ...
          right={<Button href={CONFIGURE_URL} variant="primary">CONFIGURE</Button>}
        />
      </section>
    ...
    <div className="space-y-12">
      ...
      <Card title="Start Configuration" eyebrow="ACTIVATION">
        <div className="mt-10 text-left">
          <Button href={CONFIGURE_URL} variant="primary" size="large">CONFIGURE YOUR SYSTEM</Button>
        </div>
      </Card>
    </div>
  );
